class LandingPage {
  /* eslint-disable */
    ...
    get firstImg () {return $('.landing_wrapImage__QPGJR > img')};
    get btnMore () {return $('.landing_buttonMore__ygQ77')};
    ...
    get sectionReasons () {return $('section.landing_secondSection__n0icF:nth-child(6)')};

    get h2Form () {return $('#landing_centeredText__gYBUv')};
